...
class Bill(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Recalculate the financial values of the bill.

        CANCELLED and OVERDUE are lifecycle states and are therefore
        preserved here instead of being overwritten by arithmetic.
        """

        self.consumption = self.reading.consumption

        self.energy_charge = (
            self.consumption * self.tariff.rate_per_kwh
        )
